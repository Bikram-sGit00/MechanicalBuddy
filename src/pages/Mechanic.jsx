...
const MechanicLoginPage = ({ onLogin, onBackToHome }) => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      const mechanicId = response.data.mechanic._id;

      navigator.geolocation.watchPosition(
        async (position) => {
          try {
            await axios.post(
              "http://localhost:5000/api/mechanics/update-location",
      ...
      <div className="mechanic-auth-container">
        ...
        >
          ...
          <p className="brand-description">
            Access your professional dashboard to manage emergency service
            requests, connect with nearby drivers, and grow your roadside
            assistance business.
          </p>

          <div className="feature-list-mechanic">
            <div className="feature-item-mechanic">
              <div className="feature-icon-mechanic">
                <FaShieldAlt />
              </div>
